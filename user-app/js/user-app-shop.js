(function (global) {
  ...
  function bindGoodsDetailPage(options) {
    ...
    function renderSpecOptions() {
      ...
      setText('goodsDetailSpecLabel', multi ? '规格 (' + count + ')' : '规格');
