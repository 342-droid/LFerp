...
function loadHeader() {
    ...
    if (headerContainer) {
        ...
        const isTmsPage = (pageFile.startsWith('tms_') && pageFile !== 'tms_route.html') || pageFile === 'carrier.html' || pageFile === 'logistics_rate.html' || path.includes('TMS_index.html') || href.includes('TMS_index.html');
...
(function () {
    ...
    function loadFabDock() {
        ...
        var s = document.createElement('script');
        s.id = 'lf-fab-dock-js';
        s.src = assetUrl('js/lf-fab-dock.js') + '?v=20260909-sku-freight';
        s.async = false;
        (document.body || document.head).appendChild(s);
    }
