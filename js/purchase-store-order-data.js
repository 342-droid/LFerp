...
(function() {
     ...
     * 未写 docSource/remark 时列表默认展示「门店订货汇总生成」。docSource 枚举含门店订货汇总生成、售后补送。
     ...
     * 平台配送：关联单号、采购单号均赋值；快递配送：关联单号为空（列表/详情展示层也会清空配送/收货仓库与关联单号），采购单号可正常赋值。
     */
    /**
    ...
    window.PURCHASE_STORE_ORDER_LINES = [
        ...
        { placeOrderDate: '2026-04-21', paymentDate: '2026-04-21', orderSource: '零售订单', fulfillmentMethod: '平台配送', orderStatus: '待发货', liveSession: 'ZB20260421-晚场', deliveryWarehouse: 'W002 嘉兴仓', receivingWarehouse: 'W001 南京仓', storeCode: 'ST003', storeName: '杭州西湖店', skuCode: 'SKU001', skuName: '红富士苹果', skuSource: '正常商品', skuCategoryPath: '生鲜 / 水果 / 仁果类', spec: '5kg/箱', qty: 25, qtyUnit: '件', lineAmount: 4125, shippedQty: 25, receivedQty: 25, sheetNo: 'MDH2026042118154291', sheetHeaderStatus: '已完成', sourceOrderNo: 'CO202604210028', relatedOrderNo: 'OBD202604210028', poNo: 'PO2026042211000006', createdBy: '刘洋', updatedAt: '2026-04-22 09:00:00', updatedBy: '陈晨' },
        { placeOrderDate: '2026-04-21', paymentDate: '2026-04-22', orderSource: '零售订单', fulfillmentMethod: '平台配送', orderStatus: '退款中', liveSession: 'ZB20260421-晚场', deliveryWarehouse: 'W002 嘉兴仓', receivingWarehouse: 'W001 南京仓', storeCode: 'ST003', storeName: '杭州西湖店', skuCode: 'SKU002', skuName: '香蕉', skuSource: '积分商品', skuCategoryPath: '生鲜 / 水果 / 浆果类', spec: '10kg/箱', qty: 18, qtyUnit: '份', lineAmount: 864, shippedQty: 0, receivedQty: 0, sheetNo: 'MDH2026042118154291', sourceOrderNo: 'CO202604210029' },
        { placeOrderDate: '2026-04-22', paymentDate: '2026-04-22', orderSource: '零售订单', fulfillmentMethod: '平台配送', orderStatus: '退款中', liveSession: 'ZB20260420-早场', deliveryWarehouse: 'W001 南京仓', receivingWarehouse: 'W001 南京仓', storeCode: 'ST001', storeName: '南京新街口店', skuCode: 'SKU001', skuName: '红富士苹果', skuSource: '正常商品', skuCategoryPath: '生鲜 / 水果 / 仁果类', spec: '5kg/箱', qty: 5, qtyUnit: '件', lineAmount: 425, shippedQty: 0, receivedQty: 0, sheetNo: 'MDH2026042210300055', sourceOrderNo: 'CO202604220042', relatedOrderNo: 'OBD2026042210300055', poNo: 'PO2026042209000005', createdBy: '赵刚', updatedAt: '2026-04-22 16:45:00', updatedBy: '张敏' },
        ...
        { placeOrderDate: '2026-04-25', paymentDate: '2026-04-25', orderSource: '代采订单', fulfillmentMethod: '快递配送', orderStatus: '待发货', liveSession: 'ZB20260421-晚场', deliveryWarehouse: 'W001 南京仓', receivingWarehouse: 'W001 南京仓', storeCode: 'ST004', storeName: '南京夫子庙店', skuCode: 'SKU001', skuName: '红富士苹果', skuSource: '正常商品', skuCategoryPath: '生鲜 / 水果 / 仁果类', spec: '5kg/箱', qty: 12, qtyUnit: '件', lineAmount: 1999, shippedQty: 12, receivedQty: 10, sheetNo: 'MDH2026042512000001', sheetHeaderStatus: '已完成', sourceOrderNo: 'CO202604250088', relatedOrderNo: '', poNo: 'PO2026042114000004' },
