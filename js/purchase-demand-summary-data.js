...
(function() {
     ...
     * @property {string} orderSource 见 CommonOptions.orderSource（零售订单 | 代采订单）
     * @property {string} fulfillmentMethod 见 CommonOptions（零售订单仅平台配送；代采订单：快递到店 | 平台配送）
     */
    ...
    window.PURCHASE_DEMAND_DETAIL_LINES = [
        { orderSource: '零售订单', fulfillmentMethod: '平台配送', purchaseType: '市场直采', orderNo: 'MDH20260420001', skuCode: 'SKU001', skuName: '红富士苹果', skuCategoryPath: '生鲜 / 水果 / 仁果类', storeCode: 'ST001', storeName: '南京新街口店', deliveryWarehouse: 'W001 南京仓', receivingWarehouse: 'W001 南京仓', supplier: '鲜果源商贸', orderQty: 30, salePrice: 228, unitPrice: 180, pendingQty: 30, orderTime: '2026-04-20 09:30:00', orderDate: '2026-04-20', shipDate: '2026-04-21' },
        { orderSource: '零售订单', fulfillmentMethod: '平台配送', purchaseType: '供应商直发', orderNo: 'MDH20260421001', skuCode: 'SKU002', skuName: '香蕉', skuCategoryPath: '生鲜 / 水果 / 浆果类', storeCode: 'ST001', storeName: '南京新街口店', deliveryWarehouse: 'W001 南京仓', receivingWarehouse: 'W001 南京仓', supplier: '绿园果蔬', orderQty: 15, salePrice: 98, unitPrice: 75, pendingQty: 15, orderTime: '2026-04-21 08:15:00', orderDate: '2026-04-21', shipDate: '' },
        ...
        { orderSource: '零售订单', fulfillmentMethod: '平台配送', purchaseType: '市场直采', orderNo: 'MDH20260422002', skuCode: 'SKU008', skuName: '嘎啦苹果', skuCategoryPath: '生鲜 / 水果 / 仁果类', storeCode: 'ST003', storeName: '杭州西湖店', deliveryWarehouse: 'W002 嘉兴仓', receivingWarehouse: 'W001 南京仓', supplier: '鲜果源商贸', orderQty: 25, salePrice: 198, unitPrice: 155, pendingQty: 25, orderTime: '2026-04-22 16:45:00', orderDate: '2026-04-22', shipDate: '' },
        { orderSource: '零售订单', fulfillmentMethod: '平台配送', purchaseType: '供应商直发', orderNo: 'MDH20260423001', skuCode: 'SKU004', skuName: '薯片组合装', skuCategoryPath: '食品 / 零食 / 膨化食品', storeCode: 'ST001', storeName: '南京新街口店', deliveryWarehouse: 'W001 南京仓', receivingWarehouse: 'W001 南京仓', supplier: '零食汇', orderQty: 100, salePrice: 45, unitPrice: 32, pendingQty: 100, orderTime: '2026-04-23 09:00:00', orderDate: '2026-04-23', shipDate: '2026-04-25' },
        { orderSource: '零售订单', fulfillmentMethod: '平台配送', purchaseType: '市场直采', orderNo: 'MDH20260423003', skuCode: 'SKU001', skuName: '红富士苹果', skuCategoryPath: '生鲜 / 水果 / 仁果类', storeCode: 'ST004', storeName: '北京朝阳店', deliveryWarehouse: 'W004 北京仓', receivingWarehouse: 'W004 北京仓', supplier: '鲜果源商贸', orderQty: 40, salePrice: 228, unitPrice: 180, pendingQty: 40, orderTime: '2026-04-23 11:10:00', orderDate: '2026-04-23', shipDate: '2026-04-24' },
        { orderSource: '零售订单', fulfillmentMethod: '平台配送', purchaseType: '市场直采', orderNo: 'MDH20260423004', skuCode: 'SKU003', skuName: '脐橙', skuCategoryPath: '生鲜 / 水果 / 柑橘类', storeCode: 'ST005', storeName: '苏州观前店', deliveryWarehouse: 'W002 嘉兴仓', receivingWarehouse: 'W001 南京仓', supplier: '鲜果源商贸', orderQty: 22, salePrice: 178, unitPrice: 140, pendingQty: 6, orderTime: '2026-04-23 13:00:00', orderDate: '2026-04-23', shipDate: '' },
        ...
        { orderSource: '零售订单', fulfillmentMethod: '平台配送', purchaseType: '市场直采', orderNo: 'MDH20260423008', skuCode: 'SKU008', skuName: '嘎啦苹果', skuCategoryPath: '生鲜 / 水果 / 仁果类', storeCode: 'ST001', storeName: '南京新街口店', deliveryWarehouse: 'W001 南京仓', receivingWarehouse: 'W001 南京仓', supplier: '鲜果源商贸', orderQty: 18, salePrice: 198, unitPrice: 155, pendingQty: 18, orderTime: '2026-04-23 09:50:00', orderDate: '2026-04-23', shipDate: '2026-04-24' },
        { orderSource: '零售订单', fulfillmentMethod: '平台配送', purchaseType: '供应商直发', orderNo: 'MDH20260421003', skuCode: 'SKU007', skuName: '牛奶糖', skuCategoryPath: '食品 / 零食 / 糖果', storeCode: 'ST002', storeName: '上海徐家汇店', deliveryWarehouse: 'W003 上海仓', receivingWarehouse: 'W003 上海仓', supplier: '零食汇', orderQty: 200, salePrice: 25, unitPrice: 18, pendingQty: 200, orderTime: '2026-04-21 09:45:00', orderDate: '2026-04-21', shipDate: '2026-04-23' }
    ];
})();
