...
"""
    ...
    # store archive
    STORE = [
        ["BJS00001", "冷丰演示门店", "测试通知", "加盟店", "社区生鲜店", "—", "夏利", "178****4646", "华东履约仓 / WH–SH–01", "北京市/市辖区/东城区", "地下车库", "—", "—", "营业中", "—", "—", "—", "关闭", "冻结", "2026-04-29 22:53:02"],
        ["TSN00001", "冷丰演示门店", "111", "合作店", "团购自提点", "公司11号", "张三", "138****2211", "创建门店时选择的履约仓库", "天津市/市辖区/河东区", "长三角珠宝产业园A3栋", "117.25,39.12", "138****2211", "营业中", "已进件", "T+1", "自然周", "开启", "正常", "2026-04-20 10:22:11"],
        ["SHA00001", "五角场体验店", "DDD", "同行店", "快闪零售", "李四", "李四", "186****9001", "沪东前置仓", "上海市/市辖区/浦东新区", "张江路88号", "121.58,31.20", "186****9001", "营业中", "进件中", "D+1", "自然月", "关闭", "正常", "2026-04-19 15:01:44"],
        ["HGH00001", "张江快闪店", "张三", "加盟店", "社区便利店", "张三", "张三", "—", "—", "浙江省/杭州市/余杭区", "文一西路969号", "120.05,30.28", "—", "筹备", "未进件", "—", "—", "关闭", "正常", "2026-04-18 09:33:02"],
    ]
    heads = ["门店编码", "主体名称", "门店名称", "门店合作类型", "门店类型", "绑定BD", "联系人", "手机号码", "配送仓库", "省市区", "详细地址", "经纬度", "可提现手机号", "运营状态", "进件状态", "结算类型", "结算周期", "分账服务", "门店状态", "创建时间"]
